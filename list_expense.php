        ...
        <div class="side-body">
            ...
            <div class="sidebodydiv px-4 py-2">
                <div class="sidebodyhead">
                    ...
                    <a href="./add_expense.php"><button class="listbtn">+ Add Expense</button></a>
                </div>
                ...
                <div class="container-fluid mt-4 listtable">
                    ...
                    <div class="table-wrapper">
                        <table class="example table table-hover table-striped">
                            ...
                            <?php
                            $exp_lt = $fetch->table_list_arr('m_exp', 'status', 'Active');


                            $i = 1;
                            foreach ($exp_lt as $exp) {

                                $sup_lt = $fetch->table_list_id('m_supplier', 'id', $exp['sup_id']);
                                $led_lt = $fetch->table_list_id('m_ledger', 'id', $exp['led_id']);
                                ?>
                                <tbody>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td><?php echo $sup_lt['name']; ?></td>
                                        <td><?php echo $exp['w_name']; ?></td>
                                        <td><?php echo $led_lt['name']; ?></td>
                                        <td><?php echo $exp['type']; ?></td>
                                        <td><?php echo $exp['amt']; ?></td>
                                        <td>
                                            <div class="d-flex gap-3">
                                                <a href="./edit_expense.php?exp=<?php echo $exp['id']; ?>"
