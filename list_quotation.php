        ...
        <div class="side-body">
            ...
            <div class="sidebodydiv px-4 py-2">
                <div class="sidebodyhead">
                    <h4 class="m-0">Quotation List</h4>
                </div>
                ...
                <div class="container-fluid mt-4 listtable">
                    ...
                    <div class="table-wrapper">
                        <table class="example table table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $quot_lt = $fetch->table_list_arr('m_quot', 'status', 'final');
                                $i = 1;
                                foreach ($quot_lt as $quot) {
                                    $pro_id = $quot['f_id'];
                                    $pro = $fetch->table_list_id('m_pro', 'id', $pro_id);
                                    $inv_ser = $fetch->inv_list($quot['id'], 'quot');
                                    $com_lt = $fetch->table_list_id('m_cmp', 'id', $pro['c_id']);
                                    //  print_r($inv_ser);
                                    ?>
                                    <tr>
                                        <td><?php echo $i++; ?> </td>
                                        <td>00<?php echo $quot['id']; ?>/24-25</td>
                                        <td><?php echo date("d-m-Y", strtotime($quot['date'])); ?></td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-3 align-items-center">
                                                <a href="./pdf_quotation.php?quot=<?php echo $quot['id']; ?>&type=quot"><i
