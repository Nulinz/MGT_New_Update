            ...
            <div class="sidebodydiv px-4 py-3 mb-3">
                ...
                <div class="container-fluid px-0 mt-2 stages">
                    <div class="row">
                        ...
                        <!-- In Progress List -->
                        <div class="col-sm-12 col-md-3 col-xl-6 px-2">
                            <div class="stagemain">
                                ...
                                <div class="cardmain">
                                    ...
                                    <?php
                                    $s_open = "SELECT * from `m_task` where `task_for`='$emp_log' and `status`='open'";
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-12 col-md-11 col-xl-11 mb-2 d-block mx-auto draggablecard" data-id="<?php echo $d_open['id']; ?>">
                                            ...
                                            <a href="./view_task.php?task_id=<?php echo $d_open['id']; ?>"><h6 class="mb-0"><?php echo $d_open['des']; ?>.</h6></a>
                                                <hr>
                        ...
                        <div class="col-sm-12 col-md-3 col-xl-6 px-2">
                            <div class="stagemain">
                                ...
                                <div class="cardmain">
                                    ...
                                    <?php
                                    $s_close = "SELECT * from `m_task` where `task_for`='$emp_log' and `status`='close'";
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-12 col-md-11 col-xl-11 mb-2 d-block mx-auto draggablecard" data-id="<?php echo $d_close['id']; ?>">
                                            <div class="taskname mb-2">
                                                ...
                                                <?php
                                                    ...
                                                    <a href="./img/<?php echo $d_clfile['file']; ?>" data-bs-toggle="tooltip" data-bs-title="Attachment"
                                                        download><i class="fa-solid fa-paperclip"></i>
                                                    <?php
                                                    }
                                                    ?>
                                                </div>
                                            ...
                                            <div class="taskdescp mb-1">
                                            <a href="./view_task.php?task_id=<?php echo $d_close['id']; ?>"><h6 class="mb-0"><?php echo $d_close['des']; ?>.</h6></a>
                                                <hr>
            ...
            stop: function (event, ui) {
                ...
                if (card.closest(".close-list").length) {
                    ...
                    //   console.log(originalList.parent('div').attr('data-type'));
                        ...
                        // var task_id = card.data(id);
                        // console.log(taskId);
                        // updateTotalCards();
                        window.location.replace('view_task.php?task_id='+taskId);
                        // location.reload();
                    }
                } else {
