        ...
        <div class="side-body">
            ...
            <div class="sidebodydiv px-4 py-2">
                <div class="sidebodyhead">
                    <h4 class="m-0">Ledger List</h4>
                    <a href="./add_ledger.php"><button class="listbtn">+ Add Ledger</button></a>
                </div>
                ...
                <div class="container-fluid mt-4 listtable">
                    ...
                    <div class="table-wrapper">
                        <table class="example table table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $tbl = $fetch->table_list_arr('m_ledger', 'status', 'Active');
                                $i = 1;
                                foreach ($tbl as $tb) {
                                    ?>
                                    <tr>
                                        ...
                                        <td><?php echo $tb['type']; ?></td>

                                        <td><?php echo $tb['status']; ?></td>
                                        <td>
                                            <div class="d-flex gap-3">
                                                <a href="./edit_ledger.php?led=<?php echo $tb['id']; ?>"
