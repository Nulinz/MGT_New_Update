            ...
            <div class="sidebodydiv px-4 py-2 mb-3">
                ...
                <form action="" method="POST" id="my_form">
                    <div class="container-fluid maindiv bg-white">
                        <div class="row">
                            <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                ...
                                <input type="text" class="form-control" name="l_name" id="ledgername"
                                    placeholder="Enter Ledger Name" autofocus>
                            </div>
                            <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                <label for="ledgertype">Type</label>
                                <select name="l_type" id="ledgertype" class="form-select">
                            ...
                            <!-- <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                ...
                                <input type="number" class="form-control" name="l_budget" id="budget" min="0"
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12 mt-3 d-flex justify-content-center align-items-center">
                        <input hidden type="text" name="add_ledger">
