            ...
            <div class="sidebodydiv px-4 py-2 mb-3">
                <div class="sidebodyback mb-3" onclick="goBack()">
                    <div class="backhead">
                        ...
                        <h6>Add Project Notes Form</h6>
                    </div>
                </div>
                <div class="sidebodyhead my-3">
                    <h4 class="m-0">Project Notes Details</h4>
                </div>
                    ...
                    <div class="container-fluid maindiv bg-white my-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                ...
                                <textarea rows="1" class="form-control" name="desp" id="desp"
                            ...
                            <div class="col-sm-12 col-md-4 col-xl-4 mb-3 inputs">
                                ...
                                <input type="file" class="form-control" name="note_file" id="file">
                            </div>
                        </div>
                    </div>

                    <div class="col-sm-12 col-md-12 col-xl-12 mt-3 d-flex justify-content-center align-items-center">
                        <input hidden type="text" name="add_notes">
